...
UNIFIED_MODEL_REGISTRY: Dict[str, ModelCapability] = {
    ...
    # =========================================================================
    # QWEN MODELS (Qwen2.5-Omni via llama-mtmd-cli)
    # =========================================================================
    # Note: Old Qwen2-Audio models removed due to hallucination issues.
    # Qwen2.5-Omni is the recommended replacement with better quality.
    "qwen2.5-omni-7b-q4": ModelCapability(
        model_id="qwen2.5-omni-7b-q4",
        backend="qwen",
        name="Qwen2.5-Omni 7B (Q4) - 10k+ Languages",
        description="Multimodal model supporting 10,000+ languages via llama-mtmd-cli. Q4 quantized for speed.",
        size_mb=4800,
        min_ram_gb=6.0,
        recommended_ram_gb=8.0,
        min_vram_gb=None,
        languages=["*"],  # 10,000+ languages
        tier=ModelTier.MEDIUM,
        license="Apache-2.0",
    ...
    "qwen2.5-omni-7b-q6": ModelCapability(
        model_id="qwen2.5-omni-7b-q6",
        backend="qwen",
        name="Qwen2.5-Omni 7B (Q6) - 10k+ Languages",
        description="Multimodal model supporting 10,000+ languages via llama-mtmd-cli. Q6 quantized for quality.",
        size_mb=6400,
        min_ram_gb=8.0,
        recommended_ram_gb=10.0,
        min_vram_gb=None,
    ...
    "qwen2.5-omni-7b-q8": ModelCapability(
        model_id="qwen2.5-omni-7b-q8",
        backend="qwen",
        name="Qwen2.5-Omni 7B (Q8) - 10k+ Languages",
        description="Multimodal model supporting 10,000+ languages via llama-mtmd-cli. Q8 quantized for best quality.",
        size_mb=8200,
        min_ram_gb=10.0,
        recommended_ram_gb=12.0,
        min_vram_gb=None,
    ...
    "qwen2.5-omni-3b-q4": ModelCapability(
        model_id="qwen2.5-omni-3b-q4",
        backend="qwen",
        name="Qwen2.5-Omni 3B (Q4) - 10k+ Languages",
        description="Smaller multimodal model supporting 10,000+ languages via llama-mtmd-cli. Fast on CPU.",
        size_mb=2500,
        min_ram_gb=4.0,
        recommended_ram_gb=6.0,
        min_vram_gb=None,
        ...
        gpu_preference="cpu_preferred",
        is_streaming=False,
    ),
    "qwen2.5-omni-3b-q6": ModelCapability(
        model_id="qwen2.5-omni-3b-q6",
        backend="qwen",
        name="Qwen2.5-Omni 3B (Q6) - 10k+ Languages",
        description="Smaller multimodal model supporting 10,000+ languages via llama-mtmd-cli. Q6 quantized for better quality.",
        size_mb=2900,
        min_ram_gb=5.0,
    ...
    "qwen2.5-omni-3b-q8": ModelCapability(
        model_id="qwen2.5-omni-3b-q8",
        backend="qwen",
        name="Qwen2.5-Omni 3B (Q8) - 10k+ Languages",
        description="Smaller multimodal model supporting 10,000+ languages via llama-mtmd-cli. Q8 quantized for best quality.",
        size_mb=3700,
        min_ram_gb=6.0,
        recommended_ram_gb=8.0,
        min_vram_gb=None,
